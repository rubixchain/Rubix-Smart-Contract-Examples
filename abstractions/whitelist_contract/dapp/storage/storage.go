...
func AddWhitelistedDIDToState(did string, outputFileDir string) error {
    ...
    if err == nil {
        ...
        existingState["whitelisted_dids"] = append(existingState["whitelisted_dids"], did)
...
func readExistingData(outputFile string) (map[string][]string, error) {
...
func writeUpdatedData(data map[string][]string, outputFile string) error {
