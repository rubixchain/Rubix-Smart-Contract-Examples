...
func AddWhitelistedDIDToState(did string, outputFileDir string) error {
    ...
    if err == nil {
        ...
        existingState["whitelisted_dids"] = append(existingState["whitelisted_dids"].([]string), did)
...
func readExistingData(outputFile string) (map[string]interface{}, error) {
...
func writeUpdatedData(data map[string]interface{}, outputFile string) error {
